...
def imitation_terminal_condition(env,
  ...
  #     env.robot.quadruped)
  root_pos_ref = env.ref_model.data.qpos.ravel()[0:3]
  root_rot_ref = env.ref_model.data.qpos.ravel()[3:7]
  root_pos_sim = env.model.data.qpos.ravel()[0:3]
  root_rot_sim = env.model.data.qpos.ravel()[3:7]
